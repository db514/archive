...
namespace WpfRandomSelector
{
    ...
    public partial class MainWindow : Window
    {
        ...
        public MainWindow()
        {
            ...
            if (folderSelector.configuration.StartingDirectoryList != null && folderSelector.configuration.StartingDirectoryList.Count > 0)
            {
                foreach (string currentItem in folderSelector.configuration.StartingDirectoryList)
                {
            ...
            ChkUseMinimumCount.IsChecked = folderSelector.configuration.UseMinimumFileCount;
            TxtMinimumFileCount.Text = folderSelector.configuration.MinimumFileCount.ToString();
            ChkAutomaticallyAddItemToList.IsChecked = folderSelector.configuration.AutomaticallyAddItemToViewedList;
        }
        ...
        private void SelectItem_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (RbFolder.IsChecked == true)
            {
                ...
                if (sendingButton.Name == "BtnSelectItem")
                {
                    ...
                    ClosePreviouslyOpenedExplorerWindows(folderSelector.configuration.TempImagePath, LblSelectedItem.Content.ToString());
        ...
        private void ReLoadCurrentItem_OnClick(object sender, RoutedEventArgs e)
        {
            ...
            {
                Process.Start("explorer.exe", folderSelector.configuration.TempImagePath);
            }
            else
            {
        ...
        {
            folderSelector.configuration.AutomaticallyAddItemToViewedList = ChkAutomaticallyAddItemToList.IsChecked??false;
        ...
        {
            folderSelector.configuration.UseMinimumFileCount = ChkUseMinimumCount.IsChecked ?? false;
        }
        ...
        private void TxtMinimumFileCount_TextChanged(object sender, TextChangedEventArgs e)
        {
            ...
            if(success)
            {
                folderSelector.configuration.MinimumFileCount = minimumFileCount;
            }
            else
            {
        ...
        private void Window_Closing(object sender, CancelEventArgs e)
        {
            ...
            if (Directory.Exists(folderSelector.configuration.TempImagePath))
            {
                DirectoryInfo di = new DirectoryInfo(folderSelector.configuration.TempImagePath);
        ...
        private void RerandomizeCurrentImageItem_Click(object sender, RoutedEventArgs e)
        {
            ...
            ClosePreviouslyOpenedExplorerWindows(folderSelector.configuration.TempImagePath, string.Empty);
